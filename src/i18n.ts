...
const enTranslations = {
  ...
  realEstate: {
    ...
    oracleTitle: 'ChainLink Oracle Integration',
    realVirtualWorld: 'Real World & Virtual World',
...
const esTranslations = {
  ...
  realEstate: {
    ...
    oracleTitle: 'Integración de Oráculo ChainLink',
    realVirtualWorld: 'Mundo Real y Mundo Virtual',
