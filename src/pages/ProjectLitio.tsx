...
const ProjectLitio = () => {
  ...
  const projectDetails = {
    currentInvestment: 65000,
    goalInvestment: 150000,
    progress: (65000 / 150000) * 100
  };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Chilean <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF56BB] to-[#FF8F77]">Litio Mining</span>
            </h1>
            <p className={`text-lg max-w-2xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Strategic lithium mining investment in Chile's premier mineral regions.
            </p>
          </motion.div>
          ...
          <Card className={`mb-8 ${isDarkMode ? 'bg-gray-800 border-gray-700' : ''}`}>
            ...
            <CardContent className="pt-6">
              ...
              <p className={`mb-6 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                Chilean Litio Mining represents a strategic investment opportunity in Chile's 
                thriving lithium industry. Located in one of the world's richest lithium deposits, 
                this project aims to capitalize on the growing demand for lithium in electric vehicle 
                batteries and renewable energy storage solutions.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button variant="outline" className="flex items-center gap-2">
                  ...
                  <a href="/business-plan-litio.pdf" target="_blank" rel="noopener noreferrer">
                    Business Plan
                  </a>
                </Button>
                <Button variant="outline" className="flex items-center gap-2">
                  <LinkIcon className="h-4 w-4" />
                  <a href="/disbursement-info-litio.pdf" target="_blank" rel="noopener noreferrer">
          ...
          <Card className={`mb-8 ${isDarkMode ? 'bg-gray-800 border-gray-700' : ''}`}>
            <CardHeader>
              ...
              <CardDescription>Goal: $150,000</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : ''}`}>
            <CardHeader>
              <CardTitle>Invest in Chilean Litio Mining</CardTitle>
