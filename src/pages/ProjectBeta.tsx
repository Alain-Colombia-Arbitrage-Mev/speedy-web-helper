...
const ProjectBeta = () => {
  ...
  const projectDetails = {
    ...
    goalInvestment: 180000,
    progress: (85000 / 180000) * 100
  };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Project <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF56BB] to-[#FF8F77]">Beta</span>
            </h1>
            <p className={`text-lg max-w-2xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Commercial office space in Lima, Peru.
            </p>
          </motion.div>
          ...
          <Card className={`mb-8 ${isDarkMode ? 'bg-gray-800 border-gray-700' : ''}`}>
            ...
            <CardContent className="pt-6">
              ...
              <p className={`mb-6 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                Project Beta is a premium commercial office development located in the heart of Lima, Peru. 
                This project comprises modern office spaces with state-of-the-art amenities, targeting businesses 
                and entrepreneurs looking for prime commercial real estate in a strategic location.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button variant="outline" className="flex items-center gap-2">
                  ...
                  <a href="/business-plan-beta.pdf" target="_blank" rel="noopener noreferrer">
                    Business Plan
                  </a>
                </Button>
                <Button variant="outline" className="flex items-center gap-2">
                  <LinkIcon className="h-4 w-4" />
                  <a href="/disbursement-info-beta.pdf" target="_blank" rel="noopener noreferrer">
          ...
          <Card className={`mb-8 ${isDarkMode ? 'bg-gray-800 border-gray-700' : ''}`}>
            <CardHeader>
              ...
              <CardDescription>Goal: $180,000</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : ''}`}>
            <CardHeader>
              <CardTitle>Invest in Project Beta</CardTitle>
